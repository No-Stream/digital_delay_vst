...
def main():
  ...
  plistpath = scriptpath + "/resources/DelayIdeaz-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelayIdeaz-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelayIdeaz-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelayIdeaz-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelayIdeaz-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelayIdeaz-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DelayIdeaz-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DelayIdeaz.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DelayIdeaz.iss",inplace=1):
